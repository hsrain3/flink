...
class AsyncOptions(_message.Message):
    ...
    RETRY_ENABLED_FIELD_NUMBER: _ClassVar[int]
...
class UserDefinedProcessTableFunction(_message.Message):
    __slots__ = ("payload", "arguments", "states", "key_type", "has_on_timer", "metric_enabled", "profile_enabled", "state_cache_size", "map_state_read_cache_size", "map_state_write_cache_size", "job_parameters", "runtime_context", "table_semantics", "changelog_mode")
    class ChangelogKind(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        INSERT: _ClassVar[UserDefinedProcessTableFunction.ChangelogKind]
        UPDATE_BEFORE: _ClassVar[UserDefinedProcessTableFunction.ChangelogKind]
        UPDATE_AFTER: _ClassVar[UserDefinedProcessTableFunction.ChangelogKind]
        DELETE: _ClassVar[UserDefinedProcessTableFunction.ChangelogKind]
    INSERT: UserDefinedProcessTableFunction.ChangelogKind
    UPDATE_BEFORE: UserDefinedProcessTableFunction.ChangelogKind
    UPDATE_AFTER: UserDefinedProcessTableFunction.ChangelogKind
    DELETE: UserDefinedProcessTableFunction.ChangelogKind
    class ChangelogMode(_message.Message):
        __slots__ = ("contained_kinds", "key_only_deletes")
        CONTAINED_KINDS_FIELD_NUMBER: _ClassVar[int]
        KEY_ONLY_DELETES_FIELD_NUMBER: _ClassVar[int]
        contained_kinds: _containers.RepeatedScalarFieldContainer[UserDefinedProcessTableFunction.ChangelogKind]
        key_only_deletes: bool
        def __init__(self, contained_kinds: _Optional[_Iterable[_Union[UserDefinedProcessTableFunction.ChangelogKind, str]]] = ..., key_only_deletes: bool = ...) -> None: ...
    class TableSemantics(_message.Message):
        __slots__ = ("argument_name", "data_type", "partition_by_columns", "order_by_columns", "order_by_directions", "time_column", "changelog_mode", "upsert_keys")
        class SortDirection(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            ASC_NULLS_FIRST: _ClassVar[UserDefinedProcessTableFunction.TableSemantics.SortDirection]
            ASC_NULLS_LAST: _ClassVar[UserDefinedProcessTableFunction.TableSemantics.SortDirection]
            DESC_NULLS_FIRST: _ClassVar[UserDefinedProcessTableFunction.TableSemantics.SortDirection]
            DESC_NULLS_LAST: _ClassVar[UserDefinedProcessTableFunction.TableSemantics.SortDirection]
        ASC_NULLS_FIRST: UserDefinedProcessTableFunction.TableSemantics.SortDirection
        ASC_NULLS_LAST: UserDefinedProcessTableFunction.TableSemantics.SortDirection
        DESC_NULLS_FIRST: UserDefinedProcessTableFunction.TableSemantics.SortDirection
        DESC_NULLS_LAST: UserDefinedProcessTableFunction.TableSemantics.SortDirection
        class UpsertKey(_message.Message):
            __slots__ = ("columns",)
            COLUMNS_FIELD_NUMBER: _ClassVar[int]
            columns: _containers.RepeatedScalarFieldContainer[int]
            def __init__(self, columns: _Optional[_Iterable[int]] = ...) -> None: ...
        ARGUMENT_NAME_FIELD_NUMBER: _ClassVar[int]
        DATA_TYPE_FIELD_NUMBER: _ClassVar[int]
        PARTITION_BY_COLUMNS_FIELD_NUMBER: _ClassVar[int]
        ORDER_BY_COLUMNS_FIELD_NUMBER: _ClassVar[int]
        ORDER_BY_DIRECTIONS_FIELD_NUMBER: _ClassVar[int]
        TIME_COLUMN_FIELD_NUMBER: _ClassVar[int]
        CHANGELOG_MODE_FIELD_NUMBER: _ClassVar[int]
        UPSERT_KEYS_FIELD_NUMBER: _ClassVar[int]
        argument_name: str
        data_type: Schema.FieldType
        partition_by_columns: _containers.RepeatedScalarFieldContainer[int]
        order_by_columns: _containers.RepeatedScalarFieldContainer[int]
        order_by_directions: _containers.RepeatedScalarFieldContainer[UserDefinedProcessTableFunction.TableSemantics.SortDirection]
        time_column: int
        changelog_mode: UserDefinedProcessTableFunction.ChangelogMode
        upsert_keys: _containers.RepeatedCompositeFieldContainer[UserDefinedProcessTableFunction.TableSemantics.UpsertKey]
        def __init__(self, argument_name: _Optional[str] = ..., data_type: _Optional[_Union[Schema.FieldType, _Mapping]] = ..., partition_by_columns: _Optional[_Iterable[int]] = ..., order_by_columns: _Optional[_Iterable[int]] = ..., order_by_directions: _Optional[_Iterable[_Union[UserDefinedProcessTableFunction.TableSemantics.SortDirection, str]]] = ..., time_column: _Optional[int] = ..., changelog_mode: _Optional[_Union[UserDefinedProcessTableFunction.ChangelogMode, _Mapping]] = ..., upsert_keys: _Optional[_Iterable[_Union[UserDefinedProcessTableFunction.TableSemantics.UpsertKey, _Mapping]]] = ...) -> None: ...
    ...
    JOB_PARAMETERS_FIELD_NUMBER: _ClassVar[int]
    RUNTIME_CONTEXT_FIELD_NUMBER: _ClassVar[int]
    TABLE_SEMANTICS_FIELD_NUMBER: _ClassVar[int]
    CHANGELOG_MODE_FIELD_NUMBER: _ClassVar[int]
    payload: bytes
